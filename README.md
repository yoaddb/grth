...
a. Agents are complaining that our search functionality isn't working .Find the issue and fix it.  
Friendly reminder to commit and push after completing this step.

b. We're showing only public tickets but agents can swear there are more. please select also the private tickets in the result.  
**Keep in mind the  tickets is debounced at client and also the data from server can be delayed and shown when we actually asked for new search term.**
Friendly reminder to commit and push after completing this step.
